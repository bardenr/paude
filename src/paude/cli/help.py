...
_SECTIONS: tuple[HelpSection, ...] = (
    ...
    HelpSection(
        ...
        text=(
            ...
            " Codex includes the complete release package required by its"
            " background server. Use paude upgrade NAME to refresh an existing"
            " session after updating Paude."
